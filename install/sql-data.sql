...
(NUll, 'QS_trainfocus', 2, '培训首页上方大图片广告位', 1, 0),
(NUll, 'QS_traincentreimg', 2, '培训首中部横幅广告', 1, 0),
(NUll, 'QS_indexcenter', 2, '首页中部横幅广告', 1, 0),
(NUll, 'QS_indexrecommend', 2, '首页上部名企推荐广告位', 1, 0),
(NUll, 'QS_jobfairallimg', 2, '招聘会列表页横幅', 1, 0),
(NUll, 'QS_indextopimg', 2, '首页上方横幅广告位', 1, 0),
(NUll, 'QS_yellowpage', 2, '黄页右侧广告位', 1, 0),
(NUll, 'QS_newsbanner2', 2, '资讯首页中间横幅2', 1, 0),
(NUll, 'QS_shop_index', 2, '积分商城首页轮播广告位', 1, 0),
(NUll, 'QS_campusbanner', 2, '校招首页通栏广告位', 1, 0),
(NUll, 'QS_campusmedium', 2, '校招首页中等广告位', 1, 0),
(NUll, 'QS_campusshort', 2, '校招首页短小广告位', 1, 0),
(NUll, 'QS_campusright', 2, '校招首页右侧广告位', 1, 0),
(NUll, 'QS_company_index', 2, '企业会员中心中部广告位', 1, 0),
(NUll, 'QS_hunterindexright', 2, '猎头首页右侧广告位', 1, 0),
(NUll, 'QS_trainindexright', 2, '培训首页右侧广告位', 1, 0),
...
(NUll, 'QS_37indexcenterbanner','2','37新模板首页中间横幅广告',1,0),
(NUll, 'QS_37indexcenterimg','2','37新模板首页中间格子广告',1,0),
(NUll, 'QS_37indexnewimg','2','37新模板首页下方新闻推荐广告',1,0),
(NUll, 'QS_simpleresumeallimg','2','微简历中部广告位',1,0),
(NUll, 'QS_simpleallimg','2','微招聘中部广告位',1,0);
...
(NULL, 1, '面试邀请', '', 'view', 'm/personal/interview.php', 0, 1),
(NULL, 1, '投递反馈', '', 'view', 'm/personal/apply.php', 0, 1),
(NULL, 1, '职位搜索', '', 'view', 'm/jobs-list.php', 0, 1),
(NULL, 0, '企业服务', '', 'click', '', 0, 1),
(NULL, 6, '刷新职位', 'jobs_refresh', 'click', '', 0, 1),
(NULL, 6, '职位管理', '', 'click', 'm/company/company_jobs.php', 0, 1),
(NULL, 0, '更多精彩', '', 'click', '', 0, 1),
(NULL, 6, '应聘简历', '', 'view', 'm/company/company_get_reusme.php', 0, 1),
(NULL, 1, '周边职位', 'nearby_jobs', 'click', '', 0, 1),
(NULL, 6, '简历搜索', '', 'view', 'm/resume-list.php', 0, 1),
(NULL, 9, '每日签到', 'sign_day', 'click', '', 0, 1),
(NULL, 9, '帐号绑定', 'binding', 'click', '', 0, 1),
(NULL, 9, '最近招聘会', '', 'view', 'm/jobfair-list.php', 0, 1),
(NULL, 9, '联系我们', '', 'view', 'm/about.php', 0, 1);
