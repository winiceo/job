...
if (isset($aset['page']))
{
	...
	$list = $id = array();
	$result = $db->query("SELECT id,course_name,refreshtime,starttime,contents,trainname,train_id,teacher_id,teacher_cn,category_cn,classtype_cn,train_expenses,favour_expenses,district_cn,classhour FROM ".table('course').$wheresql.$orderbysql.$limit);
