...
if (isset($aset['page']))
{
	...
	$result = $db->query("SELECT id,jobs_name,contents,jobs_qualified,companyname,refreshtime,district_cn,wage_cn FROM ".table('hunter_jobs').$wheresql.$orderbysql.$limit);	
