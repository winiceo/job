...
if (isset($aset['page']))
{
	...
	$result = $db->query("SELECT id,jobname,detailed,refreshtime,comname,is_hot,amount,deadline,district_cn,sdistrict_cn FROM ".table('simple')." ".$wheresql.$orderbysql.$limit);
	$list   = array();
